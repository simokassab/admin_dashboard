        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8 ">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <main class="p-6 sm:p-10 space-y-6 dark:bg-gray-800">
                    ...
                    <section class="grid md:grid-cols-6 grid-cols-6 gap-6">
                        ...
                        <div class="flex items-center p-8 bg-white shadow rounded-lg dark:bg-gray-600">
                            ...
                            <div>
                                <span class="block text-2xl font-bold dark:text-gray-200">{{ $second_visit }}</span>
                                <span class="block text-gray-500 dark:text-gray-200"> Second page Visit</span>
                            </div>
                        </div>
                        <div class="flex items-center p-8 bg-white shadow rounded-lg dark:bg-gray-600">
